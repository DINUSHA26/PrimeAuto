      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-5">
            <Link
              to="/products"
              className="group bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold transition-all duration-300 flex items-center gap-3 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50"
            >
              Explore Spare Parts
            ...
            <Link
              to="/booking"
              className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-xl font-bold hover:bg-white/20 transition-all duration-300 flex items-center gap-3"
            >
              Book Specialist
