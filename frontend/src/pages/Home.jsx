    ...
    <div className="bg-gray-50">
      ...
      <section className="relative -mt-10 z-20 container mx-auto px-4">
        <div className="glass grid grid-cols-2 md:grid-cols-4 gap-8 p-8 rounded-2xl border border-white/50 shadow-2xl">
          ...
          <div className="text-center px-4 border-r border-gray-100 last:border-0">
            <div className="text-4xl font-extrabold text-blue-600 mb-1">10k+</div>
          ...
          <div className="text-center px-4 border-r border-gray-100 last:border-0">
            ...
            <div className="text-sm font-medium text-gray-500 uppercase tracking-wider">Spare Parts</div>
          </div>
          <div className="text-center px-4 border-r border-gray-100 last:border-0">
            <div className="text-4xl font-extrabold text-blue-600 mb-1">24/7</div>
            <div className="text-sm font-medium text-gray-500 uppercase tracking-wider">Service Support</div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2 relative group">
              ...
              <img
                ...
                className="relative rounded-2xl shadow-2xl object-cover h-[500px] w-full transform transition-transform duration-500 group-hover:scale-[1.02]"
              />
            ...
            <div className="w-full md:w-1/2">
              ...
              <Link to="/booking" className="inline-flex items-center gap-2 bg-gray-900 text-white px-8 py-4 rounded-xl font-bold hover:bg-black transition-all">
                Book a Service
                <FaArrowRight />
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2 order-2 md:order-1">
              ...
              <Link to="/products" className="inline-flex items-center gap-2 bg-white text-gray-900 px-8 py-4 rounded-xl font-bold hover:bg-gray-100 transition-all">
                Browse Full Catalog
                <FaArrowRight />
              </Link>
            </div>
